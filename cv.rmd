...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1_pEKnmr0CZTlrGPMGmgxHUTbG4xAbfaKRYT8_1azb9I/edit?gid=340636497#gid=340636497",  
...
```{r}
if(params$pdf_mode){
  cat("View this resume online with links at https://chrishaid.github.io/cv/")
} else {
